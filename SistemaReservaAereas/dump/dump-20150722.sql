...
INSERT INTO `LOGIN` VALUES (1,'N','teste','gabriel@gmail.com'),(2,'S','admin','admin@admin.com'),(3,'N','1234','adercioreinanrocha@gmail.com'),(4,'N','1234','anderson@gmail.com');
...
CREATE TABLE `RESERVA` (
  ...
  KEY `FK_6ixlf30aij3sttofvjpk2sc3q` (`ID_VOO`),
  CONSTRAINT `FK_6ixlf30aij3sttofvjpk2sc3q` FOREIGN KEY (`ID_VOO`) REFERENCES `VOO` (`ID_VOO`),
...
INSERT INTO `CLIENTE` VALUES (1,'Gabriel Dias',1),(2,'Administrador',2),(3,'Adercio Reinan',3),(4,'Anderson Alves',4);
...
-- Dump completed on 2015-07-22  1:05:36
